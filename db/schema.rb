...
ActiveRecord::Schema.define(version: 20160224222755) do
  ...
  add_index "tag_topics", ["news", "sports", "tech", "music"], name: "index_tag_topics_on_news_and_sports_and_tech_and_music"
